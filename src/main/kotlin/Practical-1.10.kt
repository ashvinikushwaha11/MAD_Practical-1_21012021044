...
fun main() {
    ...
    val car1 = Car("RR, 2018","Ash",105, 100000.0,98950.0)
    car1.displayCarInfo()
    println("Creating Car Class Object car2 in next line")
    val car2 = Car("BMW, 2019","Krupa",115, 400000.0,399800.0)
    car2.displayCarInfo()
    println("\n********** ArrayList of Car **********")
    val carlist = ArrayList<Car>()
    carlist.add(Car("Jaguar,2020","Rutvi",100,1080000.0,1079000.0))
    carlist.add(Car("Tesla,2020","Vidhi",200,4000000.0,3998000.0))
